...
int main(){
	...
	cout << exp1 << "\t\t Post fix to preFix:" << postFixTOPreFix(convertToPostFix(exp1)) << '\n';
	cout << exp2 << "\t\t Post fix to preFix:" << postFixTOPreFix(convertToPostFix(exp2)) << '\n';
	cout << exp3 << "\t Post fix to preFix:" << postFixTOPreFix(convertToPostFix(exp3)) << '\n';
